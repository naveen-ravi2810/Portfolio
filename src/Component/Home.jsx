...
function Home({homeref}) {
  return (
    ...
    />
          ...
          <p className='text-xl'>I specialize in building web apps/sites with excellent user interfaces and secure APIs. Collaboration and problem-solving are my strengths, as I enjoy working in teams to solve new challenges and upgrade existing solutions. With a focus on user experience and data security, I strive to deliver high-quality, intuitive, and secure applications.</p>
      </div>
